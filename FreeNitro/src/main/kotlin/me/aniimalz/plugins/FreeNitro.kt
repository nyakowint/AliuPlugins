    ...
    override fun start(ctx: Context) {
        commands.registerCommand("nitro", "Free nitro! Totally not a scam 10% legit") {
            if (StoreStream.getUsers().me.premiumTier == PremiumTier.TIER_1 || StoreStream.getUsers().me.premiumTier == PremiumTier.TIER_2) {
                CommandsAPI.CommandResult("I installed the FreeNitro plugin and it worked exactly as advertised! Everything worked great without a hitch and I'm quite satisfied! Thanks Aliucord discord server! You guys are okay in my book! ☺ ❤")
            } else {
